...
class Staff(commands.Cog):
    ...
    @commands.slash_command()
    @commands.has_any_role(1115611692139819028, 1115635235795775588, 1115636523325460580, 1118966558669164564, 1115611714562555955, 1116311558331580436, 1115633196336422942, 1116311558331580436, 1122489752579485796)
